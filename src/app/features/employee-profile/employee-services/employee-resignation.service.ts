...
getEmployeePersonalDetails(companyId: number, regionId: number) {

  return this.http.get<any[]>(
    this.apiUrl +
    '/GetEmployeePersonalDetails?companyId='
    + companyId +
    '&regionId=' +
    regionId
  );
...
getEmployeeFamilyDetails(companyId:number,regionId:number){

return this.http.get<any[]>(
this.apiUrl+
'/GetEmployeeFamilyDetails?companyId='
+companyId+
'&regionId='+
regionId);

}
getEmployeeEmergencyContacts(companyId:number,regionId:number){

return this.http.get<any[]>(

this.apiUrl+

'/GetEmployeeEmergencyContacts?companyId='
...
getEmployeeReferences(companyId:number,regionId:number){

return this.http.get<any[]>(

this.apiUrl+

'/GetEmployeeReferences?companyId='
